-- Insert Preston's Pills as a mock MedMe pharmacy
...
-- Get the ID of the newly inserted pharmacy and create MedMe connection
DO $$
DECLARE
    pharmacy_uuid uuid;
BEGIN
    ...
    WHERE name = 'Preston''s Pills' AND address = '851 California St, San Francisco, CA 94108';
