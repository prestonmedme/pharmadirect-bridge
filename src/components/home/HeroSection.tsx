...
const HeroSection = () => {
  ...
  return <section className="relative py-16 sm:py-20 lg:py-24 bg-gradient-subtle overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid gap-4 sm:grid-cols-3 mb-8">
              <FeatureCard icon={Search} title="Find Nearby Pharmacies" description="Locate pharmacies in your area with real-time availability and services offered." className="text-center" />
              <FeatureCard icon={Calendar} title="Easy Online Booking" description="Schedule appointments directly through our platform with instant confirmation." className="text-center" />
              <FeatureCard icon={Shield} title="Verified Providers" description="All pharmacies are verified and meet our strict quality and safety standards." className="text-center" />
            </div>

            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row gap-4">
              <ThemedButton variant="medical" size="lg" className="w-full sm:w-auto" onClick={() => navigate('/search')}>
                Find a Pharmacy
              </ThemedButton>
