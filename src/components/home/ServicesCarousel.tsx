          ...
          {services.map((service) => {
            ...
            return (
              <Button
                key={service.id}
                variant="ghost"
                className="flex-shrink-0 w-80 h-auto p-6 flex flex-col items-start text-left hover:shadow-lg hover:border-primary/20 border border-border rounded-2xl bg-white transition-all duration-300 hover:-translate-y-1"
